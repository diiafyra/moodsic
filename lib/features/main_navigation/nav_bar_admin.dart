...
class CustomBottomNavBar extends StatelessWidget {
            ...
            child: Row(
              ...
              children: [
                _buildNavItem(
                  0,
                  currentIndex,
                  'assets/icons/icons-navigation/menu-home-admin.svg',
                  'Home',
                  onTap,
                ),
                _buildNavItem(
                  1,
                  currentIndex,
                  'assets/icons/icons-navigation/menu-users.svg',
                  'Users',
                  onTap,
                ),
                _buildNavItem(
                  2,
                  currentIndex,
                  'assets/icons/icons-navigation/menu-statistics-react.svg',
                  'User Response',
                  onTap,
                ),
                _buildNavItem(
                  3,
                  currentIndex,
                  'assets/icons/icons-navigation/menu-notification.svg',
                  'Send Noti',
                  onTap,
                ),
              ],
  ...
  Widget _buildNavItem(
    ...
    return GestureDetector(
      behavior: HitTestBehavior.translucent, // Giúp nhận nhấn cả vùng rỗng
      onTap: () => onTap(index),
      child: Container(
